...
| `.batch-row__name` | 地区 + 参保主体名称（粗体 13px） |
| `.sub-row` | 规则子行容器 |
...
26. **"规则数"列改名为"参保规则"独立列**：移除地区/参保主体单元格内的"3条规则"元信息，改为独立的"参保规则"列，显示规则数量（如 "3条"）。移除未使用的 `.batch-row__meta` CSS 样式。
...
├──────┬─────────────────────────────┬──────┬──────────┬──────────┬──────────┬──────────┬──────────┬──────────┬──────────┤
│     │ 地区 / 参保主体              │参保规则│ 账单月份 │ 台账侧   │ 系统侧   │ 系统侧   │ 台账侧   │ 台账侧   │ 台账侧   │ 操作      │
│      │                             │      │         │ 总计     │ 已核对   │ 差异     │ 已核对   │ 差异     │ 待确认   │          │
├──────┼─────────────────────────────┼──────┼─────────┼──────────┼──────────┼──────────┼──────────┼──────────┼──────────┤
│ ☑   │ 重庆 — 某科技有限公司        │ 3条  │ 2026-04 │ 10笔     │ ¥3,200.00│ ¥500.00  │ ¥3,200.00│ ¥500.00  │ ¥1,500.00│ [对账]   │
├──────┴─────────────────────────────┴──────┴─────────┴──────────┴──────────┴──────────┴──────────┴──────────┴──────────┤
...
| 地区 / 参保主体 | 分组名称以 `地区 — 参保主体` 格式展示（如 "重庆 — 某科技有限公司"），点击可展开/收起规则子行 |
