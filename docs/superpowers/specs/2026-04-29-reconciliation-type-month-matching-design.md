...
├──────┬────────────┬──────────────┬────────┬──────────┬──────────┬──────────┬──────────┬──────────┬──────────┤
│ ☐    │ 规则名称   │ 参保主体     │ 月份   │ 系统侧   │ 系统侧   │ 台账侧   │ 台账侧   │ 台账侧   │ 台账侧   │ 操作      │
│      │            │              │        │ 已核对   │ 差异     │ 总计     │ 已核对   │ 差异     │ 待确认   │          │
├──────┼────────────┼──────────────┼────────┼──────────┼──────────┼──────────┼──────────┼──────────┼──────────┤
│ ☐    │ 社保规则A  │ 某科技有限   │ 2026-04│ 2笔      │ 1笔      │ 4笔      │ 2笔      │ 1笔      │ 1笔      │ [进入核对]│
│      │            │ 公司         │        │ ¥3,420.62│ ¥1,050.00│ ¥4,477.58│ ¥3,420.62│ ¥1,056.96│ ¥1,137.50│          │
├──────┼────────────┼──────────────┼────────┼──────────┼──────────┼──────────┼──────────┼──────────┼──────────┤
│ ☐    │ 社保规则B  │ 某科技有限   │ 2026-04│ 12笔     │ —        │ 12笔     │ 12笔     │ —        │ —        │ [进入核对]│
│      │            │ 公司         │        │ ¥840.00  │          │ ¥840.00  │ ¥840.00  │          │          │          │
└──────┴────────────┴──────────────┴────────┴──────────┴──────────┴──────────┴──────────┴──────────┘
```
...
| 元素 | 变更 |
|------|------|
| 表头 | 新增 checkbox 列、参保主体列；列顺序：checkbox → 规则名称 → 参保主体 → 月份 → 系统侧已核对 → 系统侧差异 → **台账侧总计** → 台账侧已核对 → 台账侧差异 → 台账侧待确认 → 操作 |
