...
- [index.html](file:///Users/athur/PycharmProjects/qyy/prototype/reconciliation/index.html#L10-L16)
...
- `getFilteredSystemRecords()`：按筛选条件过滤系统记录  
  参考：[index.html](file:///Users/athur/PycharmProjects/qyy/prototype/reconciliation/index.html#L1206-L1216)
- `calculateDifferences()`：用 `Map` 以 `(idCard, insuranceType, billingMonth)` 作为 key 计算系统多/台账多  
  参考：[index.html](file:///Users/athur/PycharmProjects/qyy/prototype/reconciliation/index.html#L1219-L1263)
- `renderDiffTable()` / `renderPagination()` / `renderAll()`：渲染差异列表与分页状态  
  参考：[index.html](file:///Users/athur/PycharmProjects/qyy/prototype/reconciliation/index.html#L1301-L1382)
...
prototype/<module>/*.html
  ...
  ├─(optional link) styles/qingyang-design-system.css
...
- Excel 处理库：`xlsx@0.18.5`  
  引用点：[index.html](file:///Users/athur/PycharmProjects/qyy/prototype/reconciliation/index.html#L16)
- Google Fonts：Inter（对账页）、Plus Jakarta Sans（设计系统示例）  
  示例：[index.html](file:///Users/athur/PycharmProjects/qyy/prototype/reconciliation/index.html#L7-L9)、[qingyang-hro-design-system.md](file:///Users/athur/PycharmProjects/qyy/qingyang-hro-design-system.md#L24-L29)
